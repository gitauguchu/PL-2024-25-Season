...
def detail_top():
    ...
    detail_top_scorer['Team'] = detail_top_scorer['Team'].replace('\n\n', '')
...
def player_table():
    url = [f'https://www.worldfootball.net/players_list/eng-premier-league-2024-2025/nach-name/{i:d}' for i in (range(1,12))]
